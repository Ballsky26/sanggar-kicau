...
$awal = TglSql($_POST['tgl_awal']);
$akhir = TglSql($_POST['tgl_akhir']);
$awal1 = date('Y-m-d', strtotime('-1 days', strtotime($awal)));
$akhir1 = date('Y-m-d', strtotime('+1 days', strtotime($awal)));

$sql = $con->query("SELECT a.*, b.* FROM faktur as a, order_produk as b WHERE a.tgl>='$awal1' AND a.tgl<='$akhir1' AND b.kd_faktur=a.kd_faktur GROUP BY b.kd_produk ");
      ...
      <tr> 
        ...
        <td width="200px"> 
          ...
          <?php do{
                            ...
                            ?>
          <?php echo $row_pembeli['kd_faktur']; ?><br> 
